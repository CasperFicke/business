...
import os
import stripe # dit is de stripe sdk
...
class EcommerceManager:
  ...
  def __init__(self, user, *args, **kwargs):
    '''
    A whole bunch of instance variables.
    '''
    self.user            = user
    ...
    self.currency        = 'EUR' 
    self.description     = 'Business website'
      
  #-------- Application methods ---------#

  # get or create stripe id
  def stripe_id(self):
    '''
